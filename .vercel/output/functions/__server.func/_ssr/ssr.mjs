...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BJf-LfwK.mjs");
...
var manifest = {
	"23da2f85280af322b9ce9bb5c2311764913d28359c7d2852124bb732b907ac68": {
		functionName: "submitLead_createServerFn_handler",
		importer: () => import("./actions-CL5y0s5X.mjs")
	},
	"374d5a868638ebe7b099b4ad488cd8e59bc96e7b1eb22432bf348f928c954e1b": {
		functionName: "listQuotes_createServerFn_handler",
		importer: () => import("./actions-CL5y0s5X.mjs")
	},
	"71e9daf10c8b5cc968af3cbb76702bfa7048fd768a454f68892c224f6806390b": {
		functionName: "createQuote_createServerFn_handler",
		importer: () => import("./actions-CL5y0s5X.mjs")
	},
	"7fba4da8ea8a5ddadabde46ccc043d5c73c3051abce3b8753211792da4959bd3": {
		functionName: "createTicket_createServerFn_handler",
		importer: () => import("./actions-CL5y0s5X.mjs")
	},
	"8014e1f6cf70b60f75fb07fbbb012399058f4ba96b7b278e112accb0047d6a9c": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CDb-H_fB.mjs").then((n) => n.t),
